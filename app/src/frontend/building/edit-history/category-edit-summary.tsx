...
const CategoryEditSummary: React.FunctionComponent<CategoryEditSummaryProps> = (
  ...
  const {
    ...
    name_id: categoryNameID = "Άγνωστη κατηγορία",
        ...
        <div className="edit-history-category-summary">
          <h3 className="edit-history-category-title">
            {props.hyperlinkCategory && props.hyperlinkTemplate != undefined ? (
              ...
              >
                {i18n.language === "id" ? categoryNameID : categoryNameEN}
              </Link>
            ) : i18n.language === "id" ? (
              categoryNameID
            ) : (
          ...
          <ul>
            {props.fields.map((x) => {
              ...
              return (
                <li key={i18n.language === "id" ? x.title_id : x.title_en}>
                  <FieldEditSummary
                    title={i18n.language === "id" ? x.title_id : x.title_en}
                    // value={x.value}
                    // oldValue={x.oldValue}
