      ...
      <article>
        <section className="main-col">
          ...
          <p>
            ...
            Δεδομένων) εξηγεί πώς το Colouring {config.cityName} χρησιμοποιεί τα προσωπικά
            ...
            Προβολής του Δήμου Αθηναίων. Το Colouring {config.cityName} αναπτύσσεται στη
          ...
          <p>Το Colouring {config.cityName} συλλέγει τα ακόλουθα προσωπικά δεδομένα:</p>
          <p>
            ...
            κρυπτογραφικό hash μοναδικό για το Colouring {config.cityName}.
          </p>

          <h2 className="h2">Πώς συλλέγουμε τα δεδομένα σας;</h2>
          <p>
            Παρέχετε στο Colouring {config.cityName} έναν ελάχιστο όγκο προσωπικών
          ...
          <p>
            Το Colouring {config.cityName} χρησιμοποιεί τα προσωπικά σας δεδομένα ώστε να
            σας επιτρέψει να συνδεθείτε, να αποκτήσετε πρόσβαση και να
            συνεισφέρετε στο έργο Colouring {config.cityName}, και ώστε να σας παρέχουμε
          ...
          <p>
            ...
            Colouring {config.cityName} για όσο διάστημα απαιτείται για την παροχή
          ...
          <p>
            ...
            επεξεργασία. Το Colouring {config.cityName}, ως ερευνητικό έργο, επεξεργάζεται
          ...
          <p>
            Το Colouring {config.cityName} αποθηκεύει τα δεδομένα σας στο Εθνικό Δίκτυο
            ...
            διάστημα διαρκεί το έργο Colouring {config.cityName}.
          </p>

          <h2 className="h2">Πώς χρησιμοποιούμε τα cookies;</h2>
          <p>
            Το Colouring {config.cityName} χρησιμοποιεί cookies μόνο για τη βελτίωση της
          ...
          <p>
            ...
            της ιστοσελίδας Coloring {config.cityName}. Αυτή η πολιτική απορρήτου
          ...
          <p>
            Λάβετε υπόψη ότι όταν κάνετε μια συνεισφορά στο Colouring {config.cityName}
          ...
          <p>
            Λάβετε επίσης υπόψη ότι όταν συνεισφέρετε στο Colouring {config.cityName},
    ...
    return (
      <article>
        <section className="main-col">
          ...
          <h2 className="h2">
            Colouring {config.cityName} Privacy Policy with respect to personal data
          </h2>
          <p>
            This privacy policy explains how Colouring {config.cityName} uses the personal
            data we collect from you when you use our website. Colouring {config.cityName}
            ...
            Turing Institute. Colouring {config.cityName} is registered for data protection
            purposes with The Alan Turing Institute data protection office.
          </p>

          <h2 className="h2">What data do we collect?</h2>
          <p>Colouring {config.cityName} collects the following personal data:</p>
          <p>
            ...
            is stored as a cryptographic hash unique to Colouring {config.cityName}.
          </p>

          <h2 className="h2">How do we collect your data?</h2>
          <p>
            You provide Colouring {config.cityName} with a minimal amount of personal data
          ...
          <p>
            Colouring {config.cityName} uses your personal data to enable you to login to
            access and contribute to the Colouring {config.cityName} project and to provide
            ...
            Colouring {config.cityName} project.
          </p>
          <p>
            ...
            personal data they process on behalf of Colouring {config.cityName} for as long
          ...
          <p>
            ...
            {config.cityName}, as a research project, is processing your personal data in
          ...
          <p>
            Colouring {config.cityName} only uses cookies to improve the user experience of
          ...
          <p>
            ...
            {config.cityName} website. This privacy policy was last updated on 4th November
          ...
          <p>
            Please note when you make a contribution to Colouring {config.cityName}, you
          ...
          <p>
            Please also note that when you contribute to Colouring {config.cityName}, you
