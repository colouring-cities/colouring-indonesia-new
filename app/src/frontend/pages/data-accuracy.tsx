    ...
    return (
      <article>
        <section className="main-col">
          ...
          <p>
            Τα δεδομένα Colouring {config.cityName} παρέχονται «ως έχουν», χωρίς καμία
          ...
          <p>
            Τα δεδομένα Colouring {config.cityName} προέρχονται από πολλές πηγές και
    ...
    return (
      <article>
        <section className="main-col">
          ...
          <p>
            Colouring {config.cityName} data are provided "as is", without warranty of any
          ...
          <p>
            Colouring {config.cityName} data are crowdsourced from multiple sources and may
