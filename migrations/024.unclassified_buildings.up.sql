...
VALUES
-- order
('U15X','Unclassified, presumed non-residential','Unclassified, presumed non-residential','order',NULL,True);
...
VALUES
-- group
('U073X','Unclassified, presumed non-residential','Unclassified, presumed non-residential','group','U15X',True);
