...
ALTER TABLE reference_tables.buildings_landuse_class
ADD UNIQUE (landuse_id);
...
ALTER TABLE buildings
  ...
  REFERENCES reference_tables.buildings_landuse_order (landuse_id);

ALTER TABLE buildings
  ADD COLUMN IF NOT EXISTS current_landuse_group text,
  ADD FOREIGN KEY (current_landuse_group)
  REFERENCES reference_tables.buildings_landuse_group (landuse_id);

ALTER TABLE buildings
  ADD COLUMN IF NOT EXISTS current_landuse_class text,
  ADD FOREIGN KEY (current_landuse_class)
  REFERENCES reference_tables.buildings_landuse_class (landuse_id);
